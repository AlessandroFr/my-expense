...
final class Expense extends BaseEntity
{
    ...
    public function __construct(
        ...
        public readonly ?int $parentExpenseId,
        public readonly ?int $installmentSeq,
    ...
    public static function fromRow(array $row): static
    {
        return new self(
            ...
            parentExpenseId:  isset($row['parent_expense_id'])  && $row['parent_expense_id']  !== null ? (int)    $row['parent_expense_id'] : null,
            installmentSeq:   isset($row['installment_seq'])    && $row['installment_seq']    !== null ? (int)    $row['installment_seq']   : null,
            installmentTotal: isset($row['installment_total'])  && $row['installment_total']  !== null ? (int)    $row['installment_total'] : null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'parent_expense_id'  => $this->parentExpenseId,
            'installment_seq'    => $this->installmentSeq,
