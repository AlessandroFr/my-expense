...
final class Budget extends BaseEntity
{
    ...
    /** Tetto sforato: il frontend mostra un toast di errore. */
    ...
    /**
     * Dall'80% al tetto: il frontend mostra un toast di avviso. Il confronto usa
     * la percentuale grezza, non progressPct(): quella e' arrotondata a un
     * decimale e farebbe scattare l'avviso gia' a 79,95%.
     */
    public function nearLimit(): bool
    {
        ...
        return ($this->spent / $this->amount) * 100.0 >= 80.0 && $this->spent <= $this->amount;
    }
