 ...
 *
 * Guida utente SPA (single-page). Una sezione per dominio, ognuna con anchor
 * (#dashboard, #spese, ...). Funziona sia in modalita' "ospite" (header
 * minimale sostituisce la navbar) sia in modalita' loggata (navbar standard
 * gia' renderizzata da layouts.app).
 */
...
$base    = $this->baseUrl();
$isGuest = (bool) ($this->isGuest ?? false);

/* Sezioni: ordine = ordine nel TOC. 'app' = path dell'app da linkare (null = nessun link). */
$sections = [
    ['id' => 'intro',             'icon' => 'bi-house-heart',     'title' => 'Benvenuto',                       'app' => null,                'group' => 'Inizia'],
    ['id' => 'primi-passi',       'icon' => 'bi-rocket-takeoff',  'title' => 'Primi passi',                     'app' => '/setup',            'group' => 'Inizia'],
    ['id' => 'dashboard',         'icon' => 'bi-speedometer2',    'title' => 'Dashboard',                       'app' => '/dashboard',        'group' => 'Quotidianità'],
    ['id' => 'spese',             'icon' => 'bi-receipt',         'title' => 'Spese',                           'app' => '/expenses',         'group' => 'Quotidianità'],
    ['id' => 'entrate',           'icon' => 'bi-cash-stack',      'title' => 'Entrate',                         'app' => '/incomes',          'group' => 'Quotidianità'],
    ['id' => 'trasferimenti',     'icon' => 'bi-arrow-left-right','title' => 'Trasferimenti',                   'app' => '/transfers',        'group' => 'Quotidianità'],
    ['id' => 'ricorrenti',        'icon' => 'bi-arrow-repeat',    'title' => 'Spese ricorrenti',                'app' => '/recurring',        'group' => 'Quotidianità'],
    ['id' => 'categorie',         'icon' => 'bi-tags',            'title' => 'Categorie',                       'app' => '/categories',       'group' => 'Pianifica'],
    ['id' => 'budget',            'icon' => 'bi-bullseye',        'title' => 'Budget mensili',                  'app' => '/budgets',          'group' => 'Pianifica'],
    ['id' => 'conti',             'icon' => 'bi-bank',            'title' => 'Conti multipli',                  'app' => '/accounts',         'group' => 'Pianifica'],
    ['id' => 'anagrafiche',       'icon' => 'bi-person-rolodex',  'title' => 'Anagrafiche',                     'app' => '/contacts',         'group' => 'Pianifica'],
    ['id' => 'investimenti',      'icon' => 'bi-graph-up-arrow',  'title' => 'Investimenti',                    'app' => '/securities',       'group' => 'Pianifica'],
    ['id' => 'pac',               'icon' => 'bi-piggy-bank',      'title' => 'Piani di Accumulo',               'app' => '/pac',              'group' => 'Pianifica'],
    ['id' => 'report',            'icon' => 'bi-bar-chart-steps', 'title' => 'Report annuale',                  'app' => '/reports',          'group' => 'Analisi'],
    ['id' => 'rateizzazione',     'icon' => 'bi-calendar-week',   'title' => 'Rateizzazione',                   'app' => null,                'group' => 'Strumenti'],
    ['id' => 'ocr',               'icon' => 'bi-camera',          'title' => 'OCR scontrini',                   'app' => null,                'group' => 'Strumenti'],
    ['id' => 'import-csv',        'icon' => 'bi-filetype-csv',    'title' => 'Import / export CSV',             'app' => null,                'group' => 'Strumenti'],
    ['id' => 'import-bancario',   'icon' => 'bi-bank2',           'title' => 'Import estratto conto',           'app' => null,                'group' => 'Strumenti'],
    ['id' => 'backup-restore',    'icon' => 'bi-cloud-download',  'title' => 'Backup e ripristino',             'app' => '/backup/download',  'group' => 'Manutenzione'],
    ['id' => 'reset-db',          'icon' => 'bi-trash3',          'title' => 'Reset database',                  'app' => '/settings',         'group' => 'Manutenzione'],
    ['id' => 'pwa-offline',       'icon' => 'bi-phone',           'title' => 'PWA e modalità offline',          'app' => null,                'group' => 'Sistema'],
    ['id' => 'dark-mode',         'icon' => 'bi-circle-half',     'title' => 'Tema chiaro / scuro',             'app' => null,                'group' => 'Sistema'],
    ['id' => 'sicurezza-privacy', 'icon' => 'bi-shield-lock',     'title' => 'Sicurezza e privacy',             'app' => null,                'group' => 'Sistema'],
    ['id' => 'scorciatoie',       'icon' => 'bi-keyboard',        'title' => 'Riferimento rapido',              'app' => null,                'group' => 'Sistema'],
];

/* Raggruppa per gruppo (mantiene l'ordine di inserimento). */
$grouped = [];
foreach ($sections as $s) {
    $grouped[$s['group']][] = $s;
}

/* Helper: renderizza l'header di una sezione (icona + titolo + anchor + apri-app). */
$renderHead = function(array $s) use ($base, $isGuest) {
    ...
    $app   = $s['app'] ?? null;
    echo '<header class="wiki-section-head">';
    echo '<h2 id="' . $id . '"><i class="bi ' . $icon . '"></i>' . $title;
    echo '<button type="button" class="wiki-anchor-link" data-anchor="' . $id . '" title="Copia link a questa sezione" aria-label="Copia link"><i class="bi bi-link-45deg"></i></button>';
    echo '</h2>';
    if ($app !== null) {
        if ($isGuest) {
            echo '<span class="wiki-open-app-disabled" title="Accedi per aprire"><i class="bi bi-lock"></i>' . htmlspecialchars($app, ENT_QUOTES, 'UTF-8') . '</span>';
        } else {
            $href = htmlspecialchars($base . $app, ENT_QUOTES, 'UTF-8');
            echo '<a class="btn btn-sm btn-outline-primary wiki-open-app" href="' . $href . '"><i class="bi bi-box-arrow-up-right me-1"></i>Apri nell\'app</a>';
        }
    }
    echo '</header>';
};
...
<?php if ($isGuest): ?>
<div class="wiki-guest-bar">
    <div class="container d-flex align-items-center gap-3 flex-wrap">
        <a href="<?= $this->escape($base . '/wiki') ?>" class="wiki-brand">my-expense<span class="text-muted small ms-2 d-none d-sm-inline">— Guida</span></a>
        <div class="ms-auto d-flex align-items-center gap-2">
            <div class="mx-theme-segments" role="group" aria-label="Tema">
                ...
                <button type="button" class="mx-theme-btn" data-theme-mode="auto" title="Auto" aria-label="Tema auto"><i class="bi bi-circle-half"></i></button>
            </div>
            <a href="<?= $this->escape($base . '/login') ?>" class="btn btn-sm btn-primary"><i class="bi bi-box-arrow-in-right me-1"></i>Accedi</a>
        </div>
    </div>
</div>
<?php endif; ?>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="wiki-toc-offcanvas" aria-labelledby="wiki-toc-offcanvas-label">
    ...
    <div class="offcanvas-body">
        <nav class="wiki-toc-nav">
            <?php foreach ($grouped as $groupName => $groupSections): ?>
                <div class="wiki-toc-group"><?= $this->escape($groupName) ?></div>
                <?php foreach ($groupSections as $s): ?>
                    <a href="#<?= $this->escape($s['id']) ?>" data-bs-dismiss="offcanvas"><i class="bi <?= $this->escape($s['icon']) ?>"></i><span><?= $this->escape($s['title']) ?></span></a>
                <?php endforeach; ?>
            <?php endforeach; ?>
        </nav>
    </div>
    ...
    <aside class="col-lg-3 d-none d-lg-block">
        <nav class="wiki-toc">
            ...
            <?php foreach ($grouped as $groupName => $groupSections): ?>
                <div class="wiki-toc-group"><?= $this->escape($groupName) ?></div>
                <?php foreach ($groupSections as $s): ?>
                    <a href="#<?= $this->escape($s['id']) ?>"><i class="bi <?= $this->escape($s['icon']) ?>"></i><span><?= $this->escape($s['title']) ?></span></a>
                <?php endforeach; ?>
            <?php endforeach; ?>
        </nav>
    </aside>
...
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[0]); ?>
    <p class="wiki-section-lead">
    ...
    <div class="row g-3 mt-1">
        ...
        <div class="col-md-4"><div class="mx-stat-card yellow"><div class="mx-stat-l">Sezioni guida</div><div class="mx-stat-v"><?= count($sections) ?></div><div class="mx-stat-d">in questa pagina</div></div></div>
    </div>
...
<!-- ──────────────────────────────────────────────────────────── PRIMI PASSI ─ -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[1]); ?>
    <p class="wiki-section-lead">Tutto inizia con la pagina di <code>/setup</code>, dove crei l'unico utente del sistema. Da lì in poi userai sempre <code>/login</code>.</p>
    <ol>
...
<!-- ──────────────────────────────────────────────────────────── DASHBOARD ─── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[2]); ?>
    <p class="wiki-section-lead">La <strong>pagina d'arrivo</strong>: sintetizza il tuo periodo (mese in corso, trimestre, anno, ultimi 30/90 giorni o intervallo personalizzato) in quattro KPI e mostra grafici di tendenza.</p>
...
<!-- ──────────────────────────────────────────────────────────── SPESE ─────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[3]); ?>
    <p class="wiki-section-lead">Il cuore dell'app: registra ogni uscita di denaro con data, importo, categoria, conto, metodo di pagamento, fornitore, tag e allegati.</p>
...
<!-- ──────────────────────────────────────────────────────────── ENTRATE ───── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[4]); ?>
    <p class="wiki-section-lead">Mirror simmetrico delle spese: stesso pattern (CRUD inline, filtri, CSV, allegati) ma con un campo libero <strong>"Fonte"</strong> al posto della categoria-pagamento (es. <em>Stipendio</em>, <em>Freelance</em>, <em>Rimborso</em>, <em>Bonifico da Mario</em>).</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── TRASFERIMENTI -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[5]); ?>
    <p class="wiki-section-lead">Sposti soldi tra <strong>due tuoi conti</strong> (es. dal corrente al contanti, o ricarica della prepagata). Il movimento non altera il bilancio totale, ma cambia i saldi dei singoli conti.</p>
    <div class="mockup-pane">
...
<!-- ──────────────────────────────────────────────────────────── RICORRENTI ── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[6]); ?>
    <p class="wiki-section-lead">Definisci una volta una spesa che si ripete (canone Netflix, mutuo, abbonamento palestra…) e my-expense la genera <strong>automaticamente</strong> ogni volta che è scaduta.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── CATEGORIE ─── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[7]); ?>
    <p class="wiki-section-lead">Etichette per classificare le spese (e in parte le entrate). Ogni categoria ha <strong>nome, colore e icona Bootstrap</strong> personalizzabili.</p>
...
<!-- ──────────────────────────────────────────────────────────── BUDGET ────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[8]); ?>
    <p class="wiki-section-lead">Definisci un <strong>tetto mensile per categoria</strong>. Il sistema calcola in tempo reale la percentuale già spesa e ti avvisa con colori a semaforo.</p>
    <div class="mockup-pane">
...
<!-- ──────────────────────────────────────────────────────────── CONTI ─────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[9]); ?>
    <p class="wiki-section-lead">Gestisci <strong>conti multipli</strong> (corrente, contanti, carte, risparmio, investimenti). Ogni movimento è legato a un conto e ogni conto ha un saldo <strong>calcolato in tempo reale</strong>: apertura + entrate − spese.</p>
...
<!-- ──────────────────────────────────────────────────────────── ANAGRAFICHE ─ -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[10]); ?>
    <p class="wiki-section-lead">Rubrica dei tuoi <strong>fornitori e controparti</strong>: negozi, professionisti, amici da rimborsare. Ogni movimento può essere collegato a un'anagrafica.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── INVESTIMENTI -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[11]); ?>
    <p class="wiki-section-lead">Traccia <strong>strumenti finanziari</strong> (azioni, ETF, fondi, obbligazioni) detenuti su uno o più conti deposito.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── PAC ───────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[12]); ?>
    <p class="wiki-section-lead">Piani di Accumulo Capitale: <strong>versamenti periodici</strong> su fondi/ETF con tracking della performance media.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── REPORT ────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[13]); ?>
    <p class="wiki-section-lead">Vista <strong>annuale</strong> per capire le tendenze di lungo periodo. Selezioni l'anno e vedi tutto consolidato.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── RATEIZZAZIONE -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[14]); ?>
    <p class="wiki-section-lead">Dividi una spesa importante in <strong>più rate calendarizzate</strong>. Disponibile sia nel form manuale sia nell'esplosione dell'import bancario.</p>
    <div class="mockup-pane">
...
<!-- ──────────────────────────────────────────────────────────── OCR ───────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[15]); ?>
    <p class="wiki-section-lead">Scatta una foto allo scontrino, l'app estrae <strong>data e importo</strong> più probabili e precompila il form. Tutto avviene <strong>nel tuo browser</strong> — l'immagine non lascia il dispositivo.</p>
    <ol>
...
<!-- ──────────────────────────────────────────────────────────── IMPORT CSV ── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[16]); ?>
    <p class="wiki-section-lead">Sia <code>/expenses</code> sia <code>/incomes</code> permettono <strong>import/export CSV</strong> con un formato semplice e tollerante.</p>
...
<!-- ──────────────────────────────────────────────────────────── IMPORT BANK ─ -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[17]); ?>
    <p class="wiki-section-lead">Importa un estratto conto CSV (formato <strong>Banca Sella / Patavina</strong>) e my-expense crea spese, entrate e trasferimenti riconoscendo le tipologie di operazione.</p>
    <ol>
...
<!-- ──────────────────────────────────────────────────────────── BACKUP ────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[18]); ?>
    <p class="wiki-section-lead">Scarica un <strong>backup ZIP completo</strong> dei tuoi dati con un click. Contiene un dump SQL di tutte le tabelle (filtrate sul tuo utente) + la cartella degli allegati.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── RESET DB ──── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[19]); ?>
    <p class="wiki-section-lead">Cancellazione <strong>irreversibile</strong> dei tuoi dati. Pensato per chi vuole "ricominciare da zero" senza reinstallare l'app. Protetto da una sequenza di conferme.</p>
...
<!-- ──────────────────────────────────────────────────────────── PWA ───────── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[20]); ?>
    <p class="wiki-section-lead">my-expense è una <strong>Progressive Web App</strong>: la installi come fosse un'app nativa e funziona anche offline (sulle pagine già visitate).</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── DARK MODE ─── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[21]); ?>
    <p class="wiki-section-lead">Tre modalità di tema, scelta persistente nel browser (<code>localStorage[mx-theme]</code>).</p>
...
<!-- ──────────────────────────────────────────────────────────── SICUREZZA ─── -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[22]); ?>
    <p class="wiki-section-lead">my-expense gira <strong>completamente sul tuo computer</strong> (XAMPP: Apache + MySQL + PHP). Nessun dato esce mai dalla macchina.</p>
    <ul>
...
<!-- ──────────────────────────────────────────────────────────── SCORCIATOIE ─ -->
<section class="wiki-section" data-wiki-section>
    <?php $renderHead($sections[23]); ?>
    <p class="wiki-section-lead">Riferimento rapido a formati, soglie e nomi che torna utile in giro.</p>
...
<script type="module" src="<?= $this->asset('js/wiki.js') ?>"></script>
