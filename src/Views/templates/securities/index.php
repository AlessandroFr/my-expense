 ...
 *
 * Investimenti -- holdings + operazioni titoli per conto deposito.
 */
    ...
    <div class="card-body">
        ...
        <form id="security-tx-form" class="row g-2">
            ...
            <div class="col-7">
                ...
                <input type="date" name="trade_date" class="form-control" required value="<?= date('Y-m-d') ?>">
            </div>
            <div class="col-5">
...
<script type="module" src="<?= $this->asset('js/pages/securities.js') ?>"></script>
<?php $this->endSection(); ?>
