 ...
 *
 * Dashboard -- migrato da public/pages/dashboard.php.
 */
...
<div class="mx-page-header">
    <div>
        <h1>Ciao <?= $this->escape(Auth::username() ?? '') ?> 👋</h1>
        <div class="sub">Riepilogo: <span data-period-label class="fw-semibold">…</span></div>
    </div>
    <a href="<?= $this->escape($base . '/expenses') ?>" class="btn btn-primary">
...
<div class="mx-quick-actions mb-4">
    <a href="<?= $this->escape($base . '/expenses') ?>" class="mx-qa">
        <span class="mx-qa-emoji">➕</span>Nuova spesa
    </a>
    <a href="<?= $this->escape($base . '/incomes') ?>" class="mx-qa">
        <span class="mx-qa-emoji">💰</span>Aggiungi entrata
    </a>
    <a href="<?= $this->escape($base . '/budgets') ?>" class="mx-qa">
        <span class="mx-qa-emoji">🎯</span>Budget
    </a>
    <a href="<?= $this->escape($base . '/reports') ?>" class="mx-qa">
...
<script type="module" src="<?= $this->asset('js/pages/dashboard.js') ?>"></script>
<?php $this->endSection(); ?>
