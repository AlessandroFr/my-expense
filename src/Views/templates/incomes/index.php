 ...
 *
 * Entrate -- migrato da public/pages/incomes.php.
 */
            ...
            <div class="tab-pane fade show active" id="inc-tab-new" role="tabpanel">
                <form id="income-create-form" class="row g-2 align-items-end">
                    ...
                    <div class="col-6">
                        ...
                        <input type="date" name="income_date" class="form-control" value="<?= $this->escape($today) ?>" required>
                    </div>
                    <div class="col-6">
...
<script type="module" src="<?= $this->asset('js/pages/incomes.js') ?>"></script>
<?php $this->endSection(); ?>
