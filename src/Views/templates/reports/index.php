 ...
 *
 * Report annuale -- migrato da public/pages/reports.php.
 */
...
<div class="card shadow-sm mb-4"><div class="card-body">
    <h2 class="h6 mb-3 d-flex justify-content-between align-items-center">
        ...
        <a href="<?= $this->escape($base . '/contacts') ?>" class="small text-decoration-none">
...
<script type="module" src="<?= $this->asset('js/pages/reports.js') ?>"></script>
<?php $this->endSection(); ?>
