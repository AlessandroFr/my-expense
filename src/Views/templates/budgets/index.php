 ...
 *
 * Budget mensili. Migrato da public/pages/budgets.php.
 */

$this->extends('layouts.app');
$this->section('content');

$currentMonth = (string) ($this->currentMonth ?? date('Y-m'));
?>
<div class="row mb-3">
    <div class="col-12">
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <input type="month" id="budget-month" class="form-control mb-3"
               value="<?= $this->escape($currentMonth) ?>">
...
<script type="module" src="<?= $this->asset('js/pages/budgets.js') ?>"></script>
<?php $this->endSection(); ?>
