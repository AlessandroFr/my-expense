<?php
/**
 * Pagina setup — registrazione one-time del singolo utente.
 * Mostrata solo quando il DB non ha utenti (gate in public/index.php).
 */
    ...
    <div class="col-md-6 col-lg-5">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                ...
                <form method="post" action="<?= htmlspecialchars($base . '/setup', ENT_QUOTES, 'UTF-8') ?>" autocomplete="off">
                    <?= Csrf::field() ?>
