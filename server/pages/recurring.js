...
export const render = ({ csrfToken, contacts, today }) => `
<div class="row mb-3">
    <div class="col-12">
    ...
    <div class="card-body">
        ...
        <form id="recurring-create-form" class="row g-2 align-items-end">
            ${csrfField(csrfToken)}            <div class="col-6">
                ...
                <input type="date" name="start_date" class="form-control" value="${esc(today)}" required>
            </div>
            <div class="col-6">
...
<script type="module" src="${asset('js/pages/recurring.js')}"></script>
`;
