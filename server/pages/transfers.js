...
export const render = ({ csrfToken, accounts }) => {
    ...
    <div class="card-body">
        ...
        <form id="transfer-create-form" class="row g-2">
            ...
            <div class="col-5">
                ...
                <input type="date" name="transfer_date" class="form-control" required value="${today}">
            </div>
            <div class="col-12">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="transfer-edit-form">
                ${csrfField(csrfToken)}                <input type="hidden" name="id" id="transfer-edit-id" value="">
...
<script type="module" src="${asset('js/pages/transfers.js')}"></script>
`;
};
